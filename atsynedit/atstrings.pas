...
type
  ...
  private
    ...
    procedure DoLoadFromStream(Stream: TStream; AFromUTF16: boolean; out AForcedToANSI: boolean);
  ...
  public
    ...
    //file
    procedure LoadFromStream(Stream: TStream; AFromUTF16: boolean=false);
    procedure LoadFromFile(const AFilename: string);
    procedure LoadFromString(const AText: UnicodeString);
