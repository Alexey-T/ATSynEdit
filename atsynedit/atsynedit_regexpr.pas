...
type
  ...
  public
    ...
    function ExecNext(ABackward: boolean = False): boolean;
...
function InvertCase(Ch: REChar): REChar; inline;
begin
...
function TRegExpr.ExecNext(ABackward: boolean = False): boolean;
var
