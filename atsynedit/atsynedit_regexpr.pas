...
const
 ...
 begin
   ...
   Result:= UnicodeUpperCase(AChar)[1];
 ...
 begin
   ...
   Result:= UnicodeLowerCase(AChar)[1];
...
function TRegExpr.Exec : boolean; overload;
 begin
  Result := ExecPrim (1);
 end; { of function TRegExpr.Exec
--------------------------------------------------------------}
function TRegExpr.Exec (AOffset: PtrInt) : boolean; overload;
 begin
