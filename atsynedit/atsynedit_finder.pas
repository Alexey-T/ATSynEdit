...
begin
  ...
  begin
    ...
    Result:=
      (
       (FMatchEdPos.X=Mark.PosX) and
       (FMatchEdPos.Y=Mark.PosY) and
       (FMatchEdEnd.X=Mark.PosX+Mark.LineLen) and
       (FMatchEdEnd.Y=Mark.PosY)
      )
      or
      (
       (FMatchEdPos.X=Mark.PosX+Mark.LineLen) and
       (FMatchEdPos.Y=Mark.PosY) and
       (FMatchEdEnd.X=Mark.PosX) and
       (FMatchEdEnd.Y=Mark.PosY)
      );
  end
  else
