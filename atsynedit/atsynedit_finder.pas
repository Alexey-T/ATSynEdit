...
begin
  ...
  try
    try
      OptDisableOnProgress:= true; //fix CudaText flickering on scrolling (Win64, Qt5), CudaText issue #5679
    ...
    begin
      ...
      begin
        ...
        if SelX=0 then Continue; //don't add attrib for zero-len match
        Editor.Attribs.Add(
          Point(PosX, PosY),
          Point(SelX, SelY),
